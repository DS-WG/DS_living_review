...
class InspireBibGenerator:
        ...
        self.category_keywords = {
            ...
            'model_building_sun': {
                ...
                'abstract': ['su(', 'su(2)', 'su(3)', 'su(4)', 'su(5)', 'su(6)', 'su(n)', 'unitary group',
                           'special unitary', 'gauge group su', 'sun gauge'],
                'patterns': [r'su\(\d+\)', r'su\(n\)', r'special unitary', r'unitary group']
            },
            
            'model_building_non_sun': {
                'title': ['so(', 'sp(', 'usp(', 'orthogonal', 'symplectic', 'SIMPlectic', 'exceptional', 'e6', 'e7', 'e8',
                         'f4', 'g2', 'non-abelian', 'abelian'],
            ...
            'model_building_general': {
                'title': ['model', 'models', 'theory', 'theoretical', 'composite', 'gauge', 'symmetry', 
                         'mechanism', 'framework', 'construction', 'extended'],
                'abstract': ['we propose', 'new model', 'theoretical framework', 'gauge theory', 'symmetry breaking',
                           'model predicts', 'theoretical prediction', 'composite model', 'extended model',
                           'we construct', 'we introduce a model', 'theoretical approach'],
                'patterns': [r'new \w+ model', r'extended \w+ model', r'\w+ framework']
            },
            ...
            'new_signatures': {
                'title': ['signature', 'signatures', 'signal', 'signals', 'phenomenology', 'phenomenological',
                         'collider', 'production', 'decay', 'final state', 'channel'],
                'abstract': ['new signature', 'novel signature', 'phenomenology', 'collider signature',
                           'final state', 'decay channel', 'production mechanism', 'signal characteristics',
                           'distinctive signature', 'experimental signature'],
                'patterns': [r'signature of \w+', r'signal of \w+', r'phenomenology of \w+']
            },
            ...
            #'low_energy': {
            #    'title': ['low energy', 'low-energy', 'precision', 'flavor', 'flavour', 'rare decay',
            #             'anomaly', 'anomalies', 'muon', 'electron', 'neutron'],
            #    'abstract': ['low energy', 'precision measurement', 'flavor physics', 'rare decay',
            #               'anomaly', 'muon anomaly', 'electron anomaly', 'precision test',
            #               'low energy limit', 'flavor violation'],
            #    'patterns': [r'low.energy \w+', r'precision \w+', r'flavor \w+']
            #},
    ...
    def calculate_category_score(self, paper, category):
        """Calculate relevance score for a paper in a specific category"""
        ...
        # Special handling for theory papers
        if category in ['model_building_sun', 'model_building_non_sun', 'model_building_general']:
    ...
    def generate_readme(self, filename="README.md"):
        ...
        with open(output_path, 'w') as f:
            ...
            category_groups = {
                ...
                'Experimental & Phenomenology': ['experimental', 'new_signatures', 'reinterpretation'],
